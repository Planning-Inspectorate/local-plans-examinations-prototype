...
function consultationComplete(data) {
  return data['compliance-upload-complete'] &&
         data['soundness-upload-complete'] &&
...
router.get('/application-details', function (req, res) {
  ...
  if (proceduralComplete(data)) {
    data['procedural-completed'] = 'true'
  }
...
router.post('/consultation-documents/compliance-upload', function (req, res) {
...
router.post('/consultation-documents/soundness-upload', function (req, res) {
  req.session.data['consultation-started'] = 'true'
  req.session.data['soundness-upload-complete'] = 'true'
  if (req.query.cya) {
    res.redirect('../application-details')

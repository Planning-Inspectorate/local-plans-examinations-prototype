...
router.get('/upload/miq/upload-bo', (req, res) => {
	res.render('projects/back-office/manage/examination/v4/upload/miq/upload-bo', {
...
router.get('/upload/miq/check-answers', (req, res) => {
	...
	res.render('projects/back-office/manage/examination/v4/upload/miq/check-answers', {
		caseRef: req.session.currentCaseRef || '',
		serviceName: 'Manage a local plan',
		uploadedDocuments,
...
router.get('/upload/miq/remove-confirm', (req, res) => {
	...
	if (!filename || !document) {
		return res.redirect(`${req.baseUrl}/upload/miq/upload-bo`);
	}

	res.render('projects/back-office/manage/examination/v4/upload/miq/remove-confirm', {
		caseRef: req.session.currentCaseRef || '',
		serviceName: 'Manage a local plan',
		filename,

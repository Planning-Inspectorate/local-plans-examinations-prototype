...
router.get('/upload/main-mods/upload-bo', (req, res) => {
	res.render('projects/back-office/manage/examination/v4/upload/main-mods/upload-bo', {
...
router.get('/upload/main-mods/check-answers', (req, res) => {
	...
	res.render('projects/back-office/manage/examination/v4/upload/main-mods/check-answers', {
		caseRef: req.session.currentCaseRef || '',
		serviceName: 'Manage a local plan',
		uploadedDocuments,
...
router.get('/upload/main-mods/remove-confirm', (req, res) => {
	...
	if (!filename || !document) {
		return res.redirect(`${req.baseUrl}/upload/main-mods/upload-bo`);
	}

	res.render('projects/back-office/manage/examination/v4/upload/main-mods/remove-confirm', {
		caseRef: req.session.currentCaseRef || '',
		serviceName: 'Manage a local plan',
		filename,

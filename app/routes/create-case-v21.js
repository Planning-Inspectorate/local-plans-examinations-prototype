...
router.get('/projects/back-office/create-case/v21/LPA-region', (req, res) => {
  ...
  res.render('projects/back-office/create-case/v21/LPA-region', {
...
router.post('/projects/back-office/create-case/v21/LPA-region', (req, res) => {
...
// Start page
router.get('/projects/back-office/create-case/v21/index', (req, res) => {
  ...
  res.render('projects/back-office/create-case/v21/index', {
    cases: req.session.cases.slice().reverse()
  });
});

// Load case - populates session with case data and redirects to manage
router.get('/projects/back-office/create-case/v21/load-case', (req, res) => {
  const { caseRef } = req.query;
  
  // Find the case in the cases array
  if (!req.session.cases) {
    return res.redirect('/projects/back-office/create-case/v21/index');
  }
  ...
  // Redirect to the active manage overview route
  res.redirect('/projects/back-office/manage/overview/v2/index');
});

// Case officer
router.get('/projects/back-office/create-case/v21/0-case-officer-name', (req, res) => {
  const isEdit = req.query.edit === 'true';
  res.render('projects/back-office/create-case/v21/0-case-officer-name', {
...
router.post('/projects/back-office/create-case/v21/0-case-officer-name', (req, res) => {
  ...
  if (isEdit) {
    ...
    res.redirect('/projects/back-office/create-case/v21/1-plan-title');
  }
});

// Plan title page
router.get('/projects/back-office/create-case/v21/1-plan-title', (req, res) => {
  const isEdit = req.query.edit === 'true';
  res.render('projects/back-office/create-case/v21/1-plan-title', {
...
router.post('/projects/back-office/create-case/v21/1-plan-title', (req, res) => {
  ...
  if (isEdit) {
    ...
    res.redirect('/projects/back-office/create-case/v21/2-plan-type');
  }
});

// Plan type page
router.get('/projects/back-office/create-case/v21/2-plan-type', (req, res) => {
  const isEdit = req.query.edit === 'true';
  res.render('projects/back-office/create-case/v21/2-plan-type', {
...
router.post('/projects/back-office/create-case/v21/2-plan-type', (req, res) => {
  ...
  if (isEdit) {
    ...
    res.redirect('/projects/back-office/create-case/v21/3-select-LPA');
  }
});

// Select LPA page
router.get('/projects/back-office/create-case/v21/3-select-LPA', (req, res) => {
  ...
  res.render('projects/back-office/create-case/v21/3-select-LPA', {
    lpaList,
    selectedLPA,
    isEdit,
    index
...
// Additional LPA page
router.get('/projects/back-office/create-case/v21/additional-LPA', (req, res) => {
  const path = require('path');
  const fs = require('fs');
  const lpaListPath = path.join(__dirname, '../data/lpa-list.json');
  let lpaList = [];
  ...
  res.render('projects/back-office/create-case/v21/additional-LPA', { lpaList });
});
...
router.get('/projects/back-office/create-case/v21/main-contact', (req, res) => {
  const isEdit = req.query.edit === 'true';
  res.render('projects/back-office/create-case/v21/main-contact', {
...
// Remove main contact
router.post('/projects/back-office/create-case/v21/remove-main-contact', (req, res) => {
  req.session.mainContact = null;
  res.redirect('/projects/back-office/create-case/v21/main-contact');
});

// Remove additional contact
router.post('/projects/back-office/create-case/v21/remove-contact', (req, res) => {
...
router.get('/projects/back-office/create-case/v21/additional-contact', (req, res) => {
  let contact = {};
  ...
  res.render('projects/back-office/create-case/v21/additional-contact', {
    lpas: req.session.lpas || [],
    contact,
    editIndex,
    fromCheckAnswers
...
router.post('/projects/back-office/create-case/v21/additional-contact', (req, res) => {
  ...
  if (req.body.editIndex !== undefined && req.body.editIndex !== '') {
    ...
    if (fromCheckAnswers || fromCheckContactDetails) {
      ...
      return res.redirect('/projects/back-office/create-case/v21/add-another-contact');
    }
  }
});

router.get('/projects/back-office/create-case/v21/remove-contact-details-page', (req, res) => {
  ...
  res.render('projects/back-office/create-case/v21/remove-contact-details', {
    contact,
    editIndex,
    isMain
  });
...
router.post('/projects/back-office/create-case/v21/remove-contact-details-page', (req, res) => {
  ...
  if (isMain) {
    ...
    return res.redirect('/projects/back-office/create-case/v21/main-contact');
  } else if (
    typeof editIndex !== 'undefined' &&
    req.session.contacts &&
    Array.isArray(req.session.contacts) &&
...
router.get('/projects/back-office/create-case/v21/enter-key-dates', (req, res) => {
  const isEdit = req.query.edit === 'true';
  res.render('projects/back-office/create-case/v21/enter-key-dates', {
    mainContact: req.session.mainContact,
    contacts: req.session.contacts || [],
...
router.post('/projects/back-office/create-case/v21/enter-key-dates', (req, res) => {
  const isEdit = req.body.isEdit === 'true';
...
// Check answers page
router.get('/projects/back-office/create-case/v21/check-answers', (req, res) => {
  if (!req.session.contacts) req.session.contacts = [];
  if (!req.session.secondaryLPAContacts) req.session.secondaryLPAContacts = [];
  res.render('/projects/back-office/create-case/v21/check-answers', {
    mainContact: req.session.mainContact,
    contacts: req.session.contacts,
...
router.post('/projects/back-office/create-case/v21/check-answers', (req, res) => {
  ...
  res.redirect('/projects/back-office/create-case/v21/confirmation');
});

// Confirmation page
router.get('/projects/back-office/create-case/v21/confirmation', (req, res) => {
  res.render('projects/back-office/create-case/v21/confirmation', {
    caseRef: req.session.latestCaseRef || 'PLAN/000001'
  });
});

router.get('/projects/back-office/create-case/v21/clear-data', (req, res) => {
  req.session.contacts = [];
  req.session.mainContact = undefined;
  req.session.lpas = [];
  ...
  req.session.save(() => {
    res.redirect('/projects/back-office/create-case/v21/index');
  });
});
